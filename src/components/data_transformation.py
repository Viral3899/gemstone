...
class DataTransformationConfig:
    preprocessed_train_file_path = os.path.join(
        'artifact', 'data_transformation', get_current_time_stamp(), 'transformed_data', 'train', 'train.npz')
    preprocessed_test_file_path = os.path.join(
        'artifact', 'data_transformation', get_current_time_stamp(), 'transformed_data', 'test', 'test.npz')
    preprocessing_obj_file_path = os.path.join(
        'artifact', 'data_transformation', get_current_time_stamp(), 'transformation_object', 'preprocessor.pkl')
    ...
    def initaite_data_transformation(self, train_path, test_path):
        try:
            ...
            save_numpy_array_data(
                file_path=self.data_transformation_config.preprocessed_train_file_path, array=train_arr)
            save_numpy_array_data(
